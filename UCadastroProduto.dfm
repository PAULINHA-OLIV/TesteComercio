object FrmCadastroProduto: TFrmCadastroProduto
  ...
  object pnlRodaPe: TPanel
    ...
    object btnNavigator: TDBNavigator
      ...
      Width = 264
      Height = 25
      DataSource = DmComercio.DtsProduto
  ...
  object pnlCentro: TPanel
    ...
    object pgcPrincipal: TPageControl
      ...
      object tabManutencao: TTabSheet
        ...
        object DbeDescFornecedor: TDBEdit
          Left = 8
          Top = 238
          Width = 817
          Height = 21
        ...
        object RdgSituacao: TDBRadioGroup
          Left = 232
          Top = 123
          Width = 201
          Height = 34
        ...
        object DbeDtFabricacao: TDBEdit
          Left = 8
          Top = 134
          Width = 97
          Height = 21
        ...
        object DbeDataValidade: TDBEdit
          Left = 120
          Top = 134
          Width = 81
          Height = 21
          DataField = 'data_validade_produto'
          DataSource = DmComercio.DtsProduto
          TabOrder = 3
          OnKeyPress = FormKeyPress
        end
